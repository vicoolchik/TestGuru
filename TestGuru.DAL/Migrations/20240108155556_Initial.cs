        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessControlEntryId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AccessControlEntries_AccessControlEntryId",
                        column: x => x.AccessControlEntryId,
                        principalTable: "AccessControlEntries",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestCollections_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: false),
                    TestCollectionId = table.Column<Guid>(type: "uuid", nullable: true),
                    TestTakerId = table.Column<Guid>(type: "uuid", nullable: true),
                    TestTakerId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    AddedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tests_AspNetUsers_TestTakerId",
                        column: x => x.TestTakerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tests_AspNetUsers_TestTakerId1",
                        column: x => x.TestTakerId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerVisibilityPolicies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerVisibilityPolicies_Tests_TestId",
                        column: x => x.TestId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TestTakerId = table.Column<Guid>(type: "uuid", nullable: false),
                    TestId = table.Column<Guid>(type: "uuid", nullable: false),
                    StartTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    SkippedAnswersCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestAttempts_AspNetUsers_TestTakerId",
                        column: x => x.TestTakerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Answers_TestAttempts_TestAttemptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessControlEntries_TestId",
                table: "AccessControlEntries",
                column: "TestId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerVisibilityPolicies_TestId",
                table: "AnswerVisibilityPolicies",
                column: "TestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AccessControlEntryId",
                table: "AspNetUsers",
                column: "AccessControlEntryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestAttempts_TestTakerId",
                table: "TestAttempts",
                column: "TestTakerId");

            migrationBuilder.CreateIndex(
                name: "IX_TestCollections_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_TestTakerId",
                table: "Tests",
                column: "TestTakerId");

            migrationBuilder.CreateIndex(
                name: "IX_Tests_TestTakerId1",
                table: "Tests",
                column: "TestTakerId1");

            migrationBuilder.AddForeignKey(
                name: "FK_AccessControlEntries_Tests_TestId",
                table: "AccessControlEntries",
                column: "TestId",
                principalTable: "Tests",
                principalColumn: "Id",
